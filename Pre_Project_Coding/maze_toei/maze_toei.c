...
#define 	TURN_SPEED		( TOP_PWM / 2 - TOP_PWM / 6 )
#define 	TURN_SPEED2		( TOP_PWM / 2 - TOP_PWM / 6 )
#define		GAIN_KP			500
#define		ERROR			Sensor()
#define		MOVE_TIM1		50
#define		MOVE_TIM2		250
...
void BackWardToLine(void)
{
	BackWard(GROW_SPEED,GROW_SPEED);
	/*int pi = 0;
	do
	{
		pi = ERROR*GAIN_KP;
